...
client.on('message', message => {
  ...
  .setColor("#9B59B6")
  .addField(" ** :gear: Server Support :gear: **" , "  **https://discord.gg/VFGCs7E**")
...
client.on('message', message => {
        ...
        .setURL(`https://discordapp.com/api/oauth2/authorize?client_id=549948414012686336&permissions=8&scope=bot`)
        .setThumbnail("https://discordapp.com/api/oauth2/authorize?client_id=549948414012686336&permissions=8&scope=bot")        
     message.channel.sendEmbed(embed);
       }
   });
...
╚[❖════════════❖]╝
 ...
 ❖ -avatar <mention > ➾ لمعرفة صورة الخاصة بك
